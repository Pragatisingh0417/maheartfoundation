  ...
  return (
    <main className="w-full">
      ...
      <PageWithSidebar>
        ...
        <section className="max-w-7xl bg-gradient-to-b from-red-50 to-white py-20">
            ...
            >
              ...
              <div className="space-y-4 text-gray-700 leading-relaxed mt-6 text-[15px]">
                ...
                <p>
                  ...
                  without a battle for survival, I reckoned that my life could be a galvanizing tale
                  and testimony to this daunting health challenge.
                </p>
