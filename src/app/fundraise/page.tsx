  ...
  return (
    <main className="w-full">
      ...
      {/* ===========================
          FUNDRAISING OPTIONS
      ============================ */}
      <section className="max-w-6xl mx-auto px-6 py-20 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">

        {/* Card 1 */}
        <motion.div
          whileHover={{ scale: 1.03 }}
          className="bg-white shadow-xl rounded-2xl p-6 border border-red-100"
        >
