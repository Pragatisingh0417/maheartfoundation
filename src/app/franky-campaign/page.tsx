    ...
    <main className="w-full">
      ...
      <section className="bg-[#b8962e] text-white py-20 px-6 text-center">
        <h1 className="text-4xl md:text-5xl font-extrabold">
          <T>Franky Secondary School Campaign</T>
        </h1>
        <p className="text-lg md:text-xl mt-4 max-w-3xl mx-auto opacity-90">
          <T>Yaounde, Cameroon • April 25, 2025</T>
        </p>
      </section>
      <PageWithSidebar>
        {/* ============================
        ...
        <section className="max-w-5xl mx-auto px-6">
          ...
          <div className="bg-white p-10 shadow-lg border rounded-2xl">
            ...
            <p className="text-gray-800 leading-relaxed mb-6">
              <T>The “Franky Campaign” was a heart health sensitization event organized by The Mercy Azoh-Mbi Heart Foundation’s Cameroon office at Franky Bilingual Secondary and High School in Yaounde on April 25, 2025. The campaign aimed to raise awareness about heart health and early prevention among young people.</T>
            </p>
          ...
          <div className="w-full mb-8 mt-10">
            ...
            <p className="text-sm text-gray-600 mt-2 italic">
              <T>Fig 1: A group picture with Franky Secondary students and MA Heart Team, Yaounde - Cameroon</T>
            </p>
          </div>
        </section>
      </PageWithSidebar>
